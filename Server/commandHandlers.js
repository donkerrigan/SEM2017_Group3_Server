...
var updatescenario = function (data) {
	return new Promise(function(resolve, reject) {
		Scenario.updateOne({title: data.title}, {$set: {questions: data.questions, questionCount: data.questionCount, startIndex: data.startIndex}}, function(error, scenarioFound) {
